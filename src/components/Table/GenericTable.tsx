...
import type { BaseTableData, Order, TableConfig } from "./type";
                ...
                return (
                  ...
                  >
                    ...
                    {config.columns.map((column) => {
                      // For cdName column, include category in tooltip
                      let tooltipText = String(row[column.id]);
                      if (column.id === "cdName" && "cdCategory" in row && row.cdCategory) {
                        const category = String(row.cdCategory);
                        tooltipText = `${row[column.id]} (${category})`;
                      }
